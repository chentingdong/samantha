...
function Signup(props) {
  ...
  function renderConfirmationForm() {
    return (
      <div class="m-auto">
        ...
        <p>
          Please check your email to verify to finish registration. Then click{" "}
          <Link to="/user/login">login</Link>.
        </p>
        <p>
          If not received email in a minute, try{" "}
          <button onClick={resendSignUp}>resend</button>
        </p>
      </div>
    );
  }
  ...
  async function resendSignUp(event) {
    ...
    await Auth.resendSignUp("tingdong")
      .then(() => {
