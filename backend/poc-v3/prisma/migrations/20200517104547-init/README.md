# Migration `20200517104547-init`

This migration has been generated by Baiji He at 5/17/2020, 10:45:47 AM.
...
"context" text  NOT NULL DEFAULT '{}',"control" text  NOT NULL DEFAULT '{}',"description" text  NOT NULL DEFAULT '',"id" SERIAL,"inCatalog" boolean  NOT NULL DEFAULT false,"name" text  NOT NULL ,"parent" integer   ,"state" "State" NOT NULL DEFAULT 'DRAFT',"type" "BlockType" NOT NULL DEFAULT 'COMPOSITE_PARALLEL',
    PRIMARY KEY ("id"))
