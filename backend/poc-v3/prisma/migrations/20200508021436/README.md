# Migration `20200508021436`

This migration has been generated by Baiji He at 5/8/2020, 2:14:37 AM.
...
"context" text  NOT NULL DEFAULT '{}',"control" text  NOT NULL DEFAULT '{}',"id" SERIAL,"inCatalog" boolean  NOT NULL DEFAULT false,"name" text  NOT NULL ,"parent" integer   ,"state" "State" NOT NULL DEFAULT 'ACTIVE',"type" "BlockType" NOT NULL DEFAULT 'COMPOSITE_PARALLEL',
    PRIMARY KEY ("id"))
