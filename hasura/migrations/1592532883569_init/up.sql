CREATE TABLE public."blockDefState" (value text NOT NULL, comment text);
...
CREATE TABLE public."blockState" (value text NOT NULL, comment text);
CREATE TABLE public."blockType" (value text NOT NULL, comment text);
...
ADD CONSTRAINT requestors_pkey PRIMARY KEY (block_id, user_id);
ALTER TABLE ONLY public.block_responder
ADD CONSTRAINT responders_pkey PRIMARY KEY (block_id, user_id);
...
VALUES ('API', 'Action');
INSERT INTO public."blockType" (value, comment)
VALUES ('Retry', 'Decorator');
INSERT INTO public."blockType" (value, comment)
VALUES ('Repeat', 'Decorator');
INSERT INTO public."blockType" (value, comment)
VALUES ('Inverter', 'Decorator');
INSERT INTO public."blockType" (value, comment)
VALUES ('Sequence', 'Control');
INSERT INTO public."blockType" (value, comment)
VALUES ('ParallelAll', 'Control');
INSERT INTO public."blockType" (value, comment)
VALUES ('ParallelAny', 'Control');
INSERT INTO public."blockType" (value, comment)
VALUES ('Selector', 'Control');
INSERT INTO public."blockType" (value, comment)
VALUES ('ManualSelector', 'Control');
INSERT INTO public."blockType" (value, comment)
VALUES ('BehaviorTree', 'BehaviorTree');
INSERT INTO public."blockType" (value, comment)
VALUES ('Subtree', 'Action');
